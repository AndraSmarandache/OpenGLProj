...
# closed road loop: flat ring between inner and outer ellipses (oval / bike-trail style)
# inner ellipse must stay outside the relief footprint so the track sits only on flat ground
